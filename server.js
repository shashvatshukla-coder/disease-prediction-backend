...
// Configure this in .env locally or as a hosting environment variable.
const MONGO_URI = optionalEnv("MONGO_URI");
const APP_SECRET = optionalEnv("APP_SECRET", "rivayat-local-dev-secret-change-this-on-render");
const RESEND_API_KEY = optionalEnv("RESEND_API_KEY");
const EMAIL_FROM = optionalEnv("EMAIL_FROM", "RIVAYAT <orders@rivayat.in>");
